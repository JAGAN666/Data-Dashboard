...
export default function HudExplorer({ apiKey, onDataFetched }: HudExplorerProps) {
  ...
  const fetchCounties = async (stateCode: string) => {
    ...
    try {
      ...
      // For this demo, we'll simulate fetching counties
      await new Promise((resolve) => setTimeout(resolve, 1000))

      // Generate some sample counties
      const sampleCounties = [
        { name: "Main County", fips: "001" },
        { name: "North County", fips: "002" },
        { name: "South County", fips: "003" },
        { name: "East County", fips: "004" },
        { name: "West County", fips: "005" },
        { name: "Central County", fips: "006" },
      ]
